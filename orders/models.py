...
from cbd_ecommerce_proj.utils import unique_order_id_generator
...
class Order(models.Model):
    ...
    shipping_address = models.ForeignKey(
        Address, null=True, blank=True, related_name='shipping_address', on_delete=models.CASCADE)
    billing_address = models.ForeignKey(
        Address, null=True, blank=True, related_name='billing_address', on_delete=models.CASCADE)
