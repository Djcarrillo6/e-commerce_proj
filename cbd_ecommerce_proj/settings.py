"""
Django settings for cbd_ecommerce_proj project.
...
SECRET_KEY = 'y+8ud(o(^0bk#^66&%5g8obdbwwn=7tjzhhdsnytm@)mb4guu4'
...
WSGI_APPLICATION = 'cbd_ecommerce_proj.wsgi.application'
